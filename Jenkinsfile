...
// variables:
//      https://github.com/r88skeerthi/events-app-web-server.git
//      web-server-image
//      april2021-213
//      cnd-april-2021 
//      us-central1-c
    ...
    stages {
        ...
        stage('Stage 1') {
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/r88skeerthi/events-app-web-server.git'
        ...
        stage('Stage 2') {
         ...
         stage('Stage 4') {
            steps {
                ...
                sh "gcloud builds submit -t gcr.io/april2021-213/web-server-image:v2.${env.BUILD_ID} ."
            }
        }        
         stage('Stage 5') {
            steps {
